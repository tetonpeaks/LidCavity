...
def send_verification_email(user_id, email, username, jwt_token):
    subject = 'Verify Your Email'
    verification_url = url_for('verify', jwt_token=jwt_token, _external=True)
...
def register():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        send_verification_email(user_id, email, username, jwt_token)
